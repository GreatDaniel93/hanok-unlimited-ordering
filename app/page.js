    ...
    <>
      ...
      <main className="page" style={{maxWidth:900}}>
        ...
        <div className="grid grid-3" style={{marginTop:16}}>
          ...
          <a className="card" href="/manager/menu" style={{textDecoration:'none',color:'inherit'}}><h2>Manager Menu</h2><p className="muted">Add, edit, hide and restore ordering products.</p></a>
